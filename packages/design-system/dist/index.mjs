...
var Button = React2.forwardRef(
  (_a, forwardedRef) => {
    ...
    return asChild ? /* @__PURE__ */ jsx2(SlotPrimitive.Slot, __spreadProps(__spreadValues({
      ref: forwardedRef
    }, props), {
      className: classNames2,
      children: /* @__PURE__ */ jsx2(SlotPrimitive.Slottable, {
        children
      })
    })) : /* @__PURE__ */ jsx2("button", __spreadProps(__spreadValues({
      ref: forwardedRef,
      className: classNames2
    }, props), {
      children
...
var Heading = React3.forwardRef(
  (_a, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsx3(SlotPrimitive2.Slot, __spreadProps(__spreadValues({
      ref: forwardedRef,
      className: classnames2(
        className,
...
var IconBase = React4.forwardRef(
  (_a, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsx4("svg", __spreadValues({
      ref: forwardedRef,
      width: size,
      height: size,
      viewBox: "0 0 24 24",
...
var IconCheck = React6.forwardRef(
  (_a, forwardedRef) => {
    var props = __objRest(_a, []);
    return /* @__PURE__ */ jsx6(IconBase, __spreadProps(__spreadValues({
      ref: forwardedRef
    }, props), {
...
var IconButton = React8.forwardRef((_a, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx8("button", __spreadProps(__spreadValues({}, props), {
    ref: forwardedRef,
  ...
  (_a, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsxs3("svg", {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx9("defs", {
          children: /* @__PURE__ */ jsx9("clipPath", {
            id: "clip0_337_924",
            children: /* @__PURE__ */ jsx9("rect", {
              width: "40",
              height: "40",
              rx: "8",
              fill: "white"
...
var Text = React10.forwardRef(
  (_a, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsx10(SlotPrimitive3.Slot, __spreadProps(__spreadValues({
      ref: forwardedRef,
