...
var Button = React.forwardRef(
  (_a, forwardedRef) => {
    ...
    return asChild ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SlotPrimitive.Slot, __spreadProps(__spreadValues({
      ref: forwardedRef
    }, props), {
      className: classNames,
      children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SlotPrimitive.Slottable, {
        children
      })
    })) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", __spreadProps(__spreadValues({
      ref: forwardedRef,
      className: classNames
    }, props), {
      children
...
var Heading = React2.forwardRef(
  (_a, forwardedRef) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(SlotPrimitive2.Slot, __spreadProps(__spreadValues({
      ref: forwardedRef,
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Tag, {
        children
      })
    }));
  }
...
var IconBase = React3.forwardRef(
  (_a, forwardedRef) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("svg", __spreadValues({
      ref: forwardedRef,
      width: size,
      height: size,
      viewBox: "0 0 24 24",
...
var IconArrowRight = React4.forwardRef((_a, forwardedRef) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(IconBase, __spreadProps(__spreadValues({
    ref: forwardedRef
  }, props), {
    children: [
...
var IconButton = React6.forwardRef((_a, forwardedRef) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("button", __spreadProps(__spreadValues({}, props), {
    ref: forwardedRef,
      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("defs", {
          children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("clipPath", {
            id: "clip0_337_924",
            children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("rect", {
              width: "40",
              height: "40",
              rx: "8",
              fill: "white"
...
var Text = React8.forwardRef(
  (_a, forwardedRef) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(SlotPrimitive3.Slot, __spreadProps(__spreadValues({
      ref: forwardedRef,
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(Tag, {
        children
      })
    }));
  }
