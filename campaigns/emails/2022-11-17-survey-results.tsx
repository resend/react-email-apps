...
const Email = () => {
  ...
  return (
    <Html>
      <Head />
      <Preview>The results from the React Email questionnaire have been insane, with 206 responses so far.</Preview>
      <Section style={main}>
        <Text style={body}>Hey, it's Zeno Rocha.</Text>
        <Text style={body}>The results from the React Email <Link href={link}>questionnaire</Link> have been insane, with <b>206 responses</b> so far.</Text>
        <Text style={body}>There were a lot of interesting insights and ideas, so I wanted to share some of them with you...</Text>
